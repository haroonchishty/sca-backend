...
const getCompletedCasesHandler: APIGatewayProxyHandler = async (event) => {
  ...
  const params = {
    ...
    ProjectionExpression: "completedCases"
  };
...
export const handler = withUserMatch(getCompletedCasesHandler);